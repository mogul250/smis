...
const ChartTooltipContent = React.forwardRef(
  ({ active, payload, label, indicator = "dot", hideLabel = false, hideIndicator = false, className, nameKey, labelKey, ...props }, ref) => {
    const tooltipLabel = React.useMemo(() => {
      ...
      const value = !labelKey && typeof label === "string" ? itemConfig : label
